...
/**
 * @covers \vsc\domain\models\ArrayAccessT::offsetGet()
 */
class offsetGet extends \PHPUnit_Framework_TestCase
{
	...
	{
		$o = new ArrayAccessT_underTest_offsetGet();

		$sOffset = 'test';

		$this->assertNull($o[$sOffset]);
		$this->assertNull($o->offsetGet($sOffset));
	}
}

class ArrayAccessT_underTest_offsetGet implements \ArrayAccess {
	use ArrayAccessT;
